  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 w-full h-full -z-10 overflow-hidden">
        {/* Patch 1 */}
        <div className="absolute top-[-200px] left-[-200px] w-[400px] h-[400px] bg-[#00e5ff] opacity-20 blur-[200px] rotate-[20deg]"></div>

        {/* Patch 2 */}
        <div className="absolute bottom-[100px] right-[-150px] w-[300px] h-[300px] bg-[#00ffff] opacity-20 blur-[200px] rotate-[35deg]"></div>
