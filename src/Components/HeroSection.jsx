...
const Header = () => {
  return (
    <header className="bg-[#101010] text-white">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-12 py-8 lg:py-10 flex flex-col-reverse lg:flex-row items-center justify-between">
        {/* Text */}
        <div className="w-full flex-1 lg:w-1/2 space-y-6 text-center lg:text-left">
          ...
          <p className="text-gray-300 max-w-md mx-auto lg:mx-0 text-[16px] md:text-xl leading-relaxed">
