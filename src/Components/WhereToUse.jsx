...
const WhereToUse = () => {
  ...
  return (
    <div className="bg-[#202020] text-white px-5 py-20">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6 max-w-6xl mx-auto">
        {useCases.map((item, index) => (
          <div
            key={index}
            className="bg-[#383838] p-6 rounded-xl shadow-md hover:shadow-lg hover:scale-105 transition-transform duration-300 flex flex-col items-center text-center"
          >
